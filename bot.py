...
# from functions import create_company_handler, show_modal_and_price, show_prices
...
def select_watch(message):
    ...
    def create_company_handler(company, models):
        ...
        # Функция для вывода модели и цены
        ...
        def send_mess(message, comp=company, mods=models):
            ...
            if chosen_model:
                ...
                bot.send_message(message.chat.id, f"Выбранная модель часов {chosen_model} имеет стоимость в пределах {price_range} в зависимости от комплектации.")

    # Проход по каждой компании и создание обработчика
